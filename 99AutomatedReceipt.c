/*  Automated Receipt Generator In C : #66

Problem Statement :-
Suppose you have a template letter.txt. You have to fill in values to a template.
...
You have to write a program that will automatically fill the template.
For this, read this file and replace these values:
...
NOTE : Use file functions in C to accomplish the same.


// Task must be completed in this way :
...
//  Code as described/written in the Harry's video :                    // video dekh lena ek baar 

#include <stdio.h>                                            // doubt in the code must watch 
#include <string.h>
#include <stdlib.h>
